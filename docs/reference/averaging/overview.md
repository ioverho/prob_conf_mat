...
| 'max'              | [`Maximum`][prob_conf_mat.metrics.Maximum]                                                        |          |
| 'maximum'          | [`Maximum`][prob_conf_mat.metrics.Maximum]                                                        |          |
...
| 'min'              | [`Minimum`][prob_conf_mat.metrics.Minimum]                                                        |          |
| 'minimum'          | [`Minimum`][prob_conf_mat.metrics.Minimum]                                                        |          |
